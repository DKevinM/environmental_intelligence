...
MAP_JS='''(function(){
  ...
  L.control.layers(null,{'AQHI grid':aqhiLayer,'Smoke (PM2.5 model)':smokeLayer,'Community sensors':paLayer,'Official stations':stationLayer,'Active fires (satellite)':fireLayer},{collapsed:false}).addTo(map);
})();'''
